        ...
        {faqs.map(({ id, question, answer }) => (
          <div key={id}>
            <h2 id="accordion-flush-heading-1">
              <button
                onClick={() => toggelFaq(id)}
                type="button"
                className="text-lg flex items-center justify-between w-full py-5  text-left text-gray-500 border-b border-gray-200 dark:border-gray-700 dark:text-gray-400"
