  ...
  return (
    <section className="filter">
      <div
        ...
        className={`fixed z-40 h-screen p-5 overflow-y-auto bg-white w-72 dark:bg-dark transition-transhtmlForm left-0 top-0 transhtmlForm-none`}
        tabIndex="-1"
              ...
              <div className="flex items-center my-1">
                <input
                  onChange={() =>
                    dispatch({
                      type: "SORT_BY",
                      payload: { sortBy: "price-low-to-high" },
                    })
                  }
              ...
              <div className="flex items-center my-1">
                <input
                  onChange={() =>
                    dispatch({
                      type: "SORT_BY",
                      payload: { sortBy: "price-high-to-low" },
                    })
                  }
            ...
            <li className="mt-1 mb-5">
              ...
              <div className="flex items-center my-1">
                <input
                  ...
                  checked={state.ratings === "1STARTSABOVE"}
                  id="rating-sort-1"
                  type="radio"
                  value=""
                  name="rating-sort"
              ...
              <div className="flex items-center my-1">
                <input
                  ...
                  checked={state.ratings === "2STARTSABOVE"}
                  id="rating-sort-2"
                  type="radio"
                  value=""
                  name="rating-sort"
              ...
              <div className="flex items-center my-1">
                <input
                  ...
                  checked={state.ratings === "3STARTSABOVE"}
                  id="rating-sort-3"
                  type="radio"
                  value=""
                  name="rating-sort"
              ...
              <div className="flex items-center my-1">
                <input
                  ...
                  checked={state.ratings === "4STARTSABOVE"}
                  id="rating-sort-4"
                  type="radio"
                  value=""
                  name="rating-sort"
